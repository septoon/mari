...
const cardBaseClassName =
  'flex w-full items-center gap-4 rounded-[1.75rem] border border-[color:var(--line)] bg-white px-5 py-5 text-left transition hover:border-[color:var(--accent-strong)] hover:bg-[color:var(--panel)]';
    ...
    <div className="space-y-3 pb-6">
      <button type="button" onClick={onOpenStaff} className={cardBaseClassName}>
        ...
        <span className="min-w-0 flex-1">
          <span className="block text-lg font-semibold text-[color:var(--ink)]">Выбрать специалиста</span>
        ...
        <ChevronRight className="h-5 w-5 shrink-0 text-[color:var(--muted-strong)]" />
      </button>
      ...
      <button type="button" onClick={onOpenDate} className={cardBaseClassName}>
        ...
        <span className="min-w-0 flex-1">
          <span className="block text-lg font-semibold text-[color:var(--ink)]">Выбрать дату и время</span>
          <span className="mt-1 block text-sm text-[color:var(--muted)]">
            {dateLabel ??
              (serviceLabel
      ...
      <button type="button" onClick={onOpenServices} className={cardBaseClassName}>
        ...
        <span className="min-w-0 flex-1">
          <span className="block text-lg font-semibold text-[color:var(--ink)]">Выбрать услуги</span>
          <span className="mt-1 block text-sm text-[color:var(--muted)]">
