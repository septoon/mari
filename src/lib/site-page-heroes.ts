...
const SITE_PAGE_HERO_DEFAULTS: Record<SitePageHeroKey, SitePageHeroFields> = {
  about: {
    eyebrow: 'О салоне',
    title: 'МАРИ — салон, в котором красота ощущается спокойно и естественно.',
    description:
      'Мы соединяем сильную экспертизу мастеров, тёплый сервис и пространство, куда хочется возвращаться.',
  },
  booking: {
    eyebrow: 'Запись',
    title: 'Онлайн-запись в МАРИ.',
    description:
      'Выберите услугу, специалиста и удобное время для визита на отдельной странице записи.',
  },
  careers: {
    eyebrow: 'Вакансии',
    title: 'Присоединяйтесь к команде МАРИ.',
    description:
  ...
  contacts: {
    ...
    title: 'Контакты МАРИ.',
    description:
      'Позвоните, постройте маршрут или перейдите на отдельную страницу записи, если уже планируете визит.',
  },
  gallery: {
    eyebrow: 'Галерея',
    title: 'Галерея настроения, образов и пространства МАРИ.',
    description:
      'Собрали здесь детали, которые передают атмосферу салона, характер процедур и наше отношение к красоте.',
  },
  giftCards: {
    eyebrow: 'Подарочные сертификаты',
    title: 'Подарочные сертификаты МАРИ.',
  ...
  masters: {
    ...
    description:
      'Познакомьтесь со специалистами МАРИ, их направлениями и услугами, на которые можно записаться.',
  },
  masterDetails: {
  ...
  news: {
    ...
    description:
      'Здесь рассказываем о новых процедурах, пространствах, форматах ухода и приятных изменениях в МАРИ.',
  },
  newsArticle: {
  ...
  offers: {
    eyebrow: 'Акции',
    title: 'Специальные предложения МАРИ.',
    description:
  ...
  services: {
    eyebrow: 'Услуги',
    title: 'Каталог услуг МАРИ.',
    description:
      'Выберите направление, сравните процедуры по времени и стоимости и перейдите к записи в пару шагов.',
  },
  serviceCategory: {
...
const readSitePageHeroOverrides = (
...
const pickTemplate = (overrideValue: string | undefined, defaultValue: string | undefined) =>
